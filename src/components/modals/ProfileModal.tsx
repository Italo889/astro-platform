  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-[#8b63e9]/30">
            <div className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-[#8b63e9]/20">
                <User className="w-5 h-5 text-[#8b63e9]" />
              </div>
              <div>
            ...
            >
              <X className="w-5 h-5 text-[#a495c6]" />
            </button>
          </div>
          ...
          <div className="p-6 max-h-[60vh] overflow-y-auto">
            ...
            {loading && (
              <div className="flex items-center justify-center py-8">
                <Loader2 className="w-6 h-6 animate-spin text-[#8b63e9]" />
              </div>
            )}
            ...
            {activeTab === 'profile' && profile && (
              <div className="space-y-6">
                <div className="p-4 bg-[#8b63e9]/5 rounded-lg border border-[#8b63e9]/20">
                  <div className="flex items-center gap-3">
                    {profile.isBetaTester && (
                      <div className="px-2 py-1 bg-[#FFD700]/20 border border-[#FFD700]/30 rounded text-xs text-[#FFD700]">
                        Beta Tester #{profile.betaTesterNumber}
                      </div>
                    )}
                    <span className="text-sm text-[#a495c6]">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#161221] border border-[#8b63e9]/30 rounded-lg text-white placeholder-[#a495c6] focus:border-[#8b63e9] focus:outline-none transition-colors"
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full px-4 py-3 bg-[#8b63e9] hover:bg-[#a78bfa] disabled:opacity-50 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
                  >
                    <Save size={16} />
                    Salvar Alterações
                  </button>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3 pr-12 bg-[#161221] border border-[#8b63e9]/30 rounded-lg text-white placeholder-[#a495c6] focus:border-[#8b63e9] focus:outline-none transition-colors"
            ...
            {activeTab === 'privacy' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-t border-[#8b63e9]/20 pt-4">
                    <div className="p-4 bg-red-500/10 border border-red-500/30 rounded-lg mb-4">
                      <div className="flex items-center gap-2 text-red-400 mb-2">
                        <AlertTriangle size={16} />
                        <span className="font-medium">Zona de Perigo</span>
                      </div>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-3 bg-[#161221] border border-red-500/30 rounded-lg text-white placeholder-[#a495c6] focus:border-red-500 focus:outline-none transition-colors"
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="flex-1 px-4 py-2 border border-[#8b63e9]/30 text-[#a495c6] hover:text-white rounded-lg transition-colors"
                          >
                            Cancelar
                          </button>
                          <button
