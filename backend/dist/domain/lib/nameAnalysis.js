...
exports.calculateCabalisticArcanum = calculateCabalisticArcanum;
exports.calculateGematriaArcanum = calculateGematriaArcanum;
// --- MÉTODO 1: NUMEROLOGIA CABALÍSTICA (Tabela 1-9) ---
const CABALISTIC_VALUES = {
    'A': 1, 'J': 1, 'S': 1, 'Y': 1,
    'B': 2, 'K': 2, 'T': 2,
    'C': 3, 'G': 3, 'L': 3, 'Ç': 3,
    'D': 4, 'M': 4,
...
function normalizeForCabalistic(name) {
    return name.toUpperCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^A-Z]/g, "");
}
function calculateCabalisticArcanum(fullName) {
...
function normalizeForGematria(name) {
    return name.toUpperCase().replace(/[^A-ZÀ-ÿ]/g, '');
}
function calculateGematriaArcanum(fullName) {
