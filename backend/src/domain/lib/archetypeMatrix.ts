import type { CompatibilityAspect, MajorArcana } from "../types";

// A 'alma' da nossa análise. Uma matriz com interpretações para pares de arcanos.
const matrix: Record<string, Omit<CompatibilityAspect, 'title' | 'harmonyScore'>> = {
  ...
  "2-3": { // A Sacerdotisa + A Imperatriz
  ...
  "2-5": { // A Sacerdotisa + O Hierofante
  ...
  "2-6": { // A Sacerdotisa + Os Enamorados
  ...
  "3-6": { // A Imperatriz + Os Enamorados
  ...
  "3-10": { // A Imperatriz + A Roda da Fortuna
  ...
  "3-14": { // A Imperatriz + A Temperança
  ...
  "4-10": { // O Imperador + A Roda da Fortuna
  ...
  "10-20": { // Roda da Fortuna & Julgamento
  ...
  "3-20": { // A Imperatriz + O Julgamento
  ...
  "10-10": { // Roda da Fortuna & Roda da Fortuna
  ...
  "2-10": { // A Sacerdotisa + A Roda da Fortuna
  ...
  "2-12": { // A Sacerdotisa + O Enforcado
  ...
  "2-14": { // A Sacerdotisa + A Temperança
  ...
  "2-20": { // A Sacerdotisa + O Julgamento
  ...
  "5-10": { // O Hierofante + A Roda da Fortuna
  ...
  "5-14": { // O Hierofante + A Temperança
  ...
  "5-20": { // O Hierofante + O Julgamento
  ...
  "6-10": { // Enamorados & Roda da Fortuna
  ...
  "10-12": { // Roda da Fortuna & Enforcado
  ...
  "15-21": { // Diabo & Mundo (Repetido, mas com refinamento)
  ...
  "3-1": { // Imperatriz & Mago (já existe como 1-3, garantindo consistência)
    summary: "A parceria de manifestação e criação mais poderosa do Tarô.",
  ...
  "10-14": { // Roda da Fortuna & Temperança
 ...
 */
export function getArchetypeCompatibility(arcana1: MajorArcana, arcana2: MajorArcana): CompatibilityAspect {
