...
const signCompatibilityMatrix: Record<SunSignName, Record<SunSignName, number>> = {
...
function getSunSignCompatibility(sign1: SunSignName, sign2: SunSignName): CompatibilityAspect {
...
const lifePathCompatibilityMatrix: Record<number, Record<number, number>> = {
...
function getLifePathCompatibility(path1: number, path2: number): CompatibilityAspect {
